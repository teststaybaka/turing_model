"""
Latent-feedback pretraining script for the Turing machine memory tasks (recall / copy / mirror / repeat).
...
log_file = os.path.join(log_dir, "latent_pretrain_log.txt")
...
def train():
    ...
    torch.save({
        ...
        'config': config,
    }, "log/latent_pretrain_model.pt")
    print("Saved model to log/latent_pretrain_model.pt")
